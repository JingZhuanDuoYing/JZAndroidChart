...
//        chartBinding.combineChart.setMaxVisibleEntryCount(5);
//        chartBinding.combineChart.setDefaultVisibleEntryCount(3);
        chartBinding.combineChart.setMinVisibleEntryCount(12);
