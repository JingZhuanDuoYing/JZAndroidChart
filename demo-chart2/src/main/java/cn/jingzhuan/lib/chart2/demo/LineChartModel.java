...
public abstract class LineChartModel extends DataBindingEpoxyModel {
  ...
  private static final String TAG = "LineChartModel";
...
//    line.setForceValueCount(4);
    ...
    final List<Float> floats2 = Arrays.asList(
  ...
  @Override protected View buildView(@NonNull ViewGroup parent) {
    ...
    bd.lineChart.setScaleXEnable(true);
    //添加数据
...
//    line.setForceValueCount(2);

//    line.setMaxVisibleEntryCount(22);
//    line.setMinVisibleEntryCount(1);
    /**
     * 数据集合最少的数据量 不足在前面进行填充
     */
//    line.setMinValueCount(200);
//    获取数据的数量
...
//        float maxValued = line.getViewportYMax();
//
//        float minValued = line.getViewportYMin();
//
//        System.out.printf("");
//      }
//    }.start();
