 ...
 * @since 2023-03-24
 */
public abstract class BitmapCacheChart extends View implements IChart {
    ...
    public BitmapCacheChart(Context context) {
        super(context);
    }

    public BitmapCacheChart(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BitmapCacheChart(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BitmapCacheChart(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
