 ...
 * @since 2023-08-04
 */
public class JZBarDraw extends BaseDraw<BarValue, BarDataSet> {

    protected final char[] mLabelBuffer = new char[100];

    protected Paint mValueTextPaint;

    public JZBarDraw(Chart chart) {
        super(chart);
    ...
    @Override
    public void drawDataSet(Canvas canvas, ChartData<BarDataSet> chartData, BarDataSet dataSet) {
    ...
    private void drawBarDataSet(Canvas canvas, final BarDataSet barDataSet, float lMax, float lMin, float rMax, float rMin) {
