...
public class BaseChart extends Chart {
    ...
    public void setOnHighlightStatusChangeListener(
            HighlightStatusChangeListener mHighlightStatusChangeListener) {
    ...
    /**
     * 设置view 显示多少个数据集合，比如你有30个数据那么你只会显示 maxVisibleEntryCount个，其他数据请滑动查看
     *
     *
     * 如果显示数量小于这个数值那么setMinVisibleEntryCount无效
     */
    ...
    /**
     * 设置view 显示多少个数据集合，比如你有30个数据
     * 那么你只会显示 maxVisibleEntryCount个，其他数据请滑动查看
     *
    ...
    /**
     * 设置view 显示多少个数据集合，比如你有30个数据那么你只会显示 maxVisibleEntryCount个，其他数据请滑动查看
     * {@link BaseChart#setMaxVisibleEntryCount}如果被设置这个数值将无效
     * {@link BaseChart#setMinVisibleEntryCount(int)}如果被设置这个数值将无效
     * @param defaultVisibleEntryCount
     */
